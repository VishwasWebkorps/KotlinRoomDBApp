...
public class ImagePicker {
    ...
    public static Intent getPickImageIntent(Context context) {
        ...
        takePhotoIntent.putExtra(MediaStore.EXTRA_OUTPUT, FileProvider.getUriForFile(context,
                "com.assarvehicle.fileprovider",createImageFile(context)));
    ...
    public static Intent getVideoIntent(Context context) {
        ...
        //takePhotoIntent.putExtra(MediaStore.EXTRA_OUTPUT, Uri.fromFile(getTempFile(context)));
        takePhotoIntent.putExtra(MediaStore.EXTRA_OUTPUT, FileProvider.getUriForFile(context,
                "com.example.webtest.fileprovider",createVideoFile(context)));
        intentList = addIntentsToList(context, intentList, pickIntent);
        //intentList = addIntentsToList(context, intentList, takePhotoIntent);
    ...
    private static File createVideoFile(Context mContext){
        String timeStamp = new SimpleDateFormat("yyyyMMdd_HHmmss", Locale.US).format(new Date());
        File storageDir = mContext.getExternalFilesDir(Environment.DIRECTORY_PICTURES);
        File image = null;
        try {
            image = File.createTempFile(
                    timeStamp,".png",storageDir
            );
        } catch (IOException e) {
            e.printStackTrace();
        }
